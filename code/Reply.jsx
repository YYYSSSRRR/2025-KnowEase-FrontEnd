                    ...
                    <View key={b.commentid} style={{marginTop:height*0.03}}>
                        ...
                        <View style={{display:'flex',flexDirection:'row',marginTop:height*0.01,alignItems:'center'}}>
                            ...
                            <Pressable onPress={()=>handleLike(a.commentid,b.commentid)}>
                                <Image source={replyStatusMap[b.commentid]? require('../picture/alreadylike.png'):require('../picture/notlike.png')} style={{height:height*0.02,width:width*0.04,marginLeft:width*0.25,marginRight:width*0.01}}></Image>
                            </Pressable>
