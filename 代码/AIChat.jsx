    ...
    return(
        <View>
            <View style={styles.head}>
                <Image source={require('../图片/开新对话.png')} style={styles.profilePhoto} ></Image>
                        ...
                        {messages.map((item,index)=>{
                            return(
                                <View key={index} style={item.isUser?styles.rolemessage:styles.aimessage}>
                                    <Text style={{color:'white',fontSize:width*0.045}}>{item.text}</Text>
                                </View>
                            )
                        })}
            ...
            <View style={styles.bottom}>
                <Pressable onPress={()=>{navigation.navigate('Question')}} style={{display:'flex',alignItems:'center',flexDirection:'column'}}>
                    <Image source={require('../图片/问号.jpg')} style={{height:height*0.033,width:height*0.03}}></Image>
                ...
                <Pressable style={{display:'flex',alignItems:'center',flexDirection:'column'}}>
                    <Image source={require('../图片/聊天绿.png')} style={{height:height*0.03,width:height*0.03}}></Image>
